...
export default function AddPage() {
        return (
                <div className='h-64 flex flex-col space-y-6 items-center bg-no-repeat bg-cover bg-[url("https://images.pexels.com/photos/273204/pexels-photo-273204.jpeg?auto=compress&cs=tinysrgb&w=600")] '>
